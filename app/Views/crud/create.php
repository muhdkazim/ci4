<div class="card card-primary rounded-0">
    <div class="card-header">
        <h4 class="text-muted"><i class="far fa-plus-square"></i> Add New User Details</h4>
    </div>
    <div class="card-body">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="password" class="form-control" id="password" name="password" required="required" value="<?= isset($data['password']) ? $data['password'] : '' ?>">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label for="confirm_password">Confirm Password:</label>
                            <input type="password" class="form-control" id="confirm_password" name="confirm_password" value="<?= isset($data['confirm_password']) ? $data['confirm_password'] : '' ?>" required>
                        </div>
                    </div>
                </div>
                <div class="mb-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
